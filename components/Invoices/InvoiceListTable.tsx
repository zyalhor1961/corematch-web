...
export default function InvoiceListTable({ orgId }: { orgId: string }) {
    ...
    return (
        <>
            ...
            <div className="w-full overflow-hidden rounded-2xl border border-white/10 bg-[#0F172A]/60 backdrop-blur-xl shadow-2xl shadow-black/50 relative">
                ...
                <table className="w-full text-left text-sm">
                    {/* HEADER: Darker, Matte */}
                    <thead className="bg-transparent text-[10px] uppercase tracking-widest text-slate-500 font-bold border-b border-white/5">
                        <tr>
