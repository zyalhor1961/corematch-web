            ...
            <div className="group cursor-pointer">
              <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-500 transform hover:-translate-y-2">
                <div className="flex items-center mb-6">
                  ...
                  <div>
                    <h3 className="text-2xl font-bold text-gray-900">CV Screening</h3>
                    <p className="text-gray-500 text-sm">Recrutement IA</p>
                  </div>
                </div>
                ...
                <a href="/products/cv-screening" className="inline-flex items-center text-blue-600 font-medium hover:text-blue-700 transition-colors">
                  Découvrir le module
            ...
            <div className="group cursor-pointer">
              <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-500 transform hover:-translate-y-2">
                <div className="flex items-center mb-6">
                  ...
                  <div>
                    <h3 className="text-2xl font-bold text-gray-900">DEB Assistant</h3>
                    <p className="text-gray-500 text-sm">Automatisation documentaire</p>
                  </div>
                </div>
                ...
                <a href="/products/deb-assistant" className="inline-flex items-center text-green-600 font-medium hover:text-green-700 transition-colors">
                  Découvrir le module
                  <svg className="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 8l4 4m0 0l-4 4m4-4H3" />
                  </svg>
